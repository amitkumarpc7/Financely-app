...
// isExpenseModalVisible for Visiblity of Modal, handleExpenseCancel for canceling the modal,
// onFinish to finish when form is finished
const AddExpenseModal = ({
    isExpenseModalVisible,
    handleExpenseCancel,
    onFinish,
  }) => {
    // Form imported from antDesign 
